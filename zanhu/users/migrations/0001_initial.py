# Generated by Django 2.1.7 on 2019-03-15 13:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_title', models.CharField(blank=True, max_length=50, null=True, verbose_name='职称')),
                ...
                ('personal_url', models.URLField(blank=True, max_length=255, null=True, verbose_name='个人链接')),
                ('weibo', models.URLField(blank=True, max_length=255, null=True, verbose_name='微博链接')),
                ('zhihu', models.URLField(blank=True, max_length=255, null=True, verbose_name='知乎链接')),
                ('github', models.URLField(blank=True, max_length=255, null=True, verbose_name='GitHub链接')),
                ('linkedin', models.URLField(blank=True, max_length=255, null=True, verbose_name='LinkedIn链接')),
